...
running command...
$ locala (--version)
locala/0.8.0 darwin-x64 node-v18.13.0
$ locala --help [COMMAND]
USAGE
  $ locala COMMAND
...
...
_See code: [dist/commands/generate/index.ts](https://github.com/locala-io/locala/blob/v0.8.0/dist/commands/generate/index.ts)_
